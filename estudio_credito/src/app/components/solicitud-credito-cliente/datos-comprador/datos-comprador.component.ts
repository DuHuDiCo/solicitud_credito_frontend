...
export class DatosCompradorComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute, private locationSt: LocationStrategy ,private emisor: SolicituCreditoClienteEmisorService, private credito : CreditoService,private router: Router, private toast: NgToastService) { }
